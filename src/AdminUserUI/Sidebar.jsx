...
import { FaTachometerAlt, FaSync, FaFileAlt, FaList, FaChartBar, FaPrint, FaSignOutAlt, FaSearch, FaBars, FaTimes } from "react-icons/fa";
    ...
    <>
      ...
      >
        ...
        <nav className="flex-1 px-4 py-2 space-y-2">
          ...
          <Link to="/loan-process" className="flex items-center space-x-3 p-2 rounded-lg hover:bg-blue-500 transition">
            <FaSync />
